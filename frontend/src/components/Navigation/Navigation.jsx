            ...
            <Navbar bg="dark" className="navbar" variant="dark" fixed="top" data-testid="navigation-1">
                <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        <Button variant="secondary" className="gray-button" onClick={handleShow}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
